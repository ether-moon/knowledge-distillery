...
| `changed_files` | string[] | Relative paths of files changed in the PR. Used for auto domain derivation (cli.md §6) |
...
- Auto domain derivation from changed files: cli.md §6
